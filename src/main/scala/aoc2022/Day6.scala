...
object Day6 {
  ...
  val part1Sample1 = "mjqjpqmgbljsphdztnvjfqwrcgsmlb"
  val part1Sample2 = "bvwbjplbgvbhsrlpgdmjqwftvncz"
  val part1Sample3 = "nppdvjthqldpwncqszvftbrmjlhg"
  val part1Sample4 = "nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg"
  val part1Sample5 = "zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw"
  val part1Input =
  ...
  def getPacketStartIndex(input: String): Int = {
    getIndexAfterUniqueChars(input, 4, 0)
  }

  def getMessageStartIndex(input: String): Int = {
